...
- Source files carry a `/** Olgun Özoktaş geliştirdi · API Lab */` header (or
  `// Olgun Özoktaş geliştirdi · API Lab` for `.zig`). When you add a new file
  to `frontend/src/` or `src/`, drop the same one-line header at the top.
