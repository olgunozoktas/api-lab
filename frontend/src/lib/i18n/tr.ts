...
export const tr = {
  ...
  "collections.context.newMcp": "Yeni MCP isteği",
  ...
  "history.context.compareWith": "Şununla karşılaştır…",
  ...
  "tabs.compareResponse": "Yanıtı şununla karşılaştır…",
  ...
  "integrations.toast.enabledMcp": "{name} MCP sunucularına eklendi",
  ...
  "mcp.stdioNativeOnly": "stdio yerel uygulamayı gerektirir",
  "mcp.command": "Komut",
  "mcp.commandPlaceholder": "Komut (örn. npx)",
  "mcp.serverArgs": "Sunucu argümanları",
  "mcp.argsPlaceholder": "Argümanlar (örn. -y @modelcontextprotocol/server-everything)",
  "mcp.url": "Sunucu URL'si",
  "mcp.urlPlaceholder": "https://example.com/mcp",
  "mcp.listTools": "Araçları listele",
  "mcp.noTools": "Bu sunucu hiçbir araç sunmuyor.",
  "mcp.callHeading": "{name} çağır",
  "mcp.argsLabel": "Araç argümanları (JSON)",
  "mcp.call": "Aracı çağır",
  "mcp.argsInvalid": "Argümanlar geçerli JSON olmalı.",
  "mcp.callError": "Çağrı başarısız: {error}",
  "mcp.servers.title": "MCP sunucuları",
  "mcp.servers.add": "+ Sunucu ekle",
  "mcp.servers.empty": "Henüz MCP sunucusu yok. Eklemek için başla.",
  "mcp.servers.defaultName": "Yeni sunucu",
  "mcp.servers.unnamed": "(adsız)",
  "mcp.servers.namePlaceholder": "Ad (örn. Notion local)",
  "mcp.servers.nameLabel": "Sunucu adı",
  "mcp.servers.descriptionPlaceholder": "Açıklama (opsiyonel)",
  "mcp.servers.descriptionLabel": "Sunucu açıklaması",
  "mcp.servers.edit": "Düzenle",
  "mcp.servers.delete": "Sil",
  "mcp.servers.openInTab": "Sekmede aç",
  "mcp.servers.saved": "MCP sunucuları kaydedildi",
  "mcp.servers.nameRequired": "Sunucuya önce bir ad ver",
  "mcp.requestPanel.selectServer": "MCP sunucusu seç",
  "mcp.requestPanel.noServer": "Başlamak için yukarıdaki çubuktan kayıtlı bir MCP sunucusu seç.",
  "mcp.requestPanel.manageServers": "Yönet",
  "mcp.requestPanel.deletedServer": "(silinmiş sunucu — başka seç)",
  "mcp.request.save": "Kaydet",
  "mcp.servers.refresh": "Yenile",
  "mcp.servers.refreshOk": "{name} yenilendi — {count} araç",
  "mcp.servers.refreshFailed": "{name} yenilenemedi: {error}",
  "mcp.servers.integrationBadge": "Entegrasyon",
  "mcp.servers.integrationLocked": "Entegrasyonlar'dan yönet",
  "mcp.requestPanel.tools.refresh": "Araçları yenile",
  "mcp.requestPanel.tools.count": "{n} araç",
  "mcp.requestPanel.tools.notListed":
    '{name} sunucusunun sunduğu araçları yüklemek için "List tools"a tıkla.',
};
