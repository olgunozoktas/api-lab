...
export const en: Dict = {
  ...
  "collections.context.newMcp": "New MCP request",
  ...
  "history.context.compareWith": "Compare with…",
  ...
  "tabs.compareResponse": "Compare response with…",
  ...
  "integrations.stale": "Update available",
  "integrations.update": "Update",
  "integrations.toast.enabled": "{name} enabled — {count} requests imported",
  "integrations.toast.updated": "{name} updated to the latest spec",
  "integrations.toast.disabled": "{name} disabled",
  "integrations.toast.enabledMcp": "{name} installed in MCP servers",
  ...
  "mcp.stdioNativeOnly": "stdio needs the native app",
  "mcp.command": "Command",
  "mcp.commandPlaceholder": "Command (e.g. npx)",
  "mcp.serverArgs": "Server arguments",
  "mcp.argsPlaceholder": "Arguments (e.g. -y @modelcontextprotocol/server-everything)",
  "mcp.url": "Server URL",
  "mcp.urlPlaceholder": "https://example.com/mcp",
  "mcp.listTools": "List tools",
  "mcp.noTools": "This server exposes no tools.",
  "mcp.callHeading": "Call {name}",
  "mcp.argsLabel": "Tool arguments (JSON)",
  "mcp.call": "Call tool",
  "mcp.argsInvalid": "Arguments must be valid JSON.",
  "mcp.callError": "Call failed: {error}",
  "mcp.servers.title": "MCP servers",
  "mcp.servers.add": "+ Add server",
  "mcp.servers.empty": "No MCP servers yet. Add one to start.",
  "mcp.servers.defaultName": "New server",
  "mcp.servers.unnamed": "(unnamed)",
  "mcp.servers.namePlaceholder": "Name (e.g. Notion local)",
  "mcp.servers.nameLabel": "Server name",
  "mcp.servers.descriptionPlaceholder": "Description (optional)",
  "mcp.servers.descriptionLabel": "Server description",
  "mcp.servers.edit": "Edit",
  "mcp.servers.delete": "Delete",
  "mcp.servers.openInTab": "Open in tab",
  "mcp.servers.saved": "MCP servers saved",
  "mcp.servers.nameRequired": "Give the server a name first",
  "mcp.requestPanel.selectServer": "Select an MCP server",
  "mcp.requestPanel.noServer": "Pick a saved MCP server from the bar above to start.",
  "mcp.requestPanel.manageServers": "Manage",
  "mcp.requestPanel.deletedServer": "(deleted server — pick another)",
  "mcp.request.save": "Save",
  "mcp.servers.refresh": "Refresh",
  "mcp.servers.refreshOk": "{name} refreshed — {count} tools",
  "mcp.servers.refreshFailed": "{name} refresh failed: {error}",
  "mcp.servers.integrationBadge": "Integration",
  "mcp.servers.integrationLocked": "Manage in Integrations",
  "mcp.requestPanel.tools.refresh": "Refresh tools",
  "mcp.requestPanel.tools.count": "{n} tools",
  "mcp.requestPanel.tools.notListed": 'Click "List tools" to load what {name} exposes.',
};
