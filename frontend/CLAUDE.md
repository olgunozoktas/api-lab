...
9. If a package requires network during postinstall (puppeteer, playwright, sharp pre-built binary download), use the package's SKIP_DOWNLOAD env var or equivalent — do not skip `dnpm`.
